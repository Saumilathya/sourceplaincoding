...
const CourseContentList: FC<Props> = (props) => {
  ...
  return (
    <div className={`mt-2 w-full ${!props.isDemo && ' px-2 sticky top-24 left-0 z-30'}`}>
      {videoSections.map((section: string, sectionIndex: number) => {
        ...
        return (
          <div className={`${!props.isDemo && 'border-b border-[#ffffff1c] pb-2'}`} key={section}>
            <div className="w-full flex">
              {/* Render video section */}
              <div className="w-full flex justify-between items-center"
              >
                <h2 className="text-[18px] text-black dark:text-white">{section}</h2>
                <button
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        <h1 className="text-[16px] inline-block break-words text-black dark:text-white">
                          {item.title}
                        </h1>
                      </div>
